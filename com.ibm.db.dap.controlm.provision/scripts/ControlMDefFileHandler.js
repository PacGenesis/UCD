...
function ControlMDefFileHandler(baseDir, applicationName, componentName,
		appClient, propertyClient) {
	this.dir = baseDir;
	this.applicationName = applicationName;
	this.componentName = componentName;
	this.appClient = appClient;
	this.propertyClient = propertyClient;
	this.versions = this.appClient.getComponentVersions(componentName,
...
ControlMDefFileHandler.prototype = {
	...
	executeUpdateVersion : function(fil, version) {
		var versionId = propertyClient.createVersion(componentName, version, "")
				.toString();
		...
		propertyClient.addVersionFiles(componentName, version, fDir, ".",
